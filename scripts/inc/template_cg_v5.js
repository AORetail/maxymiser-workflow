function template({ campaign, campaignFiles, variant, variantFiles }) {
	var orderIndex = 0;
				...
				return `
					{
						...
						Data: preval\`module.exports = require("./inline").js("${filePath}")\`,
						Order: ${orderIndex++},
		...
		.map(function({ name, filePath, ext }) {
			if (ext === 'js') {
				...
				return `
								{
									Type: 'Css',
									Data: preval\`module.exports = require("./inline").scss("${filePath}")\`,
									Attrs: {}
								}`;
			}
